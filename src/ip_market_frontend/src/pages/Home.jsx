...
const Home = () => {
  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-gradient-to-br from-yellow-300 via-pink-400 to-purple-500 p-6 flex flex-col items-center justify-start text-white">
      {/* Hero Section */}
      <section className="w-full max-w-5xl py-14 text-center relative z-10 animate-fade-in">
        ...
        <div className="mt-10 space-x-4">
          <button
            ...
            className="bg-white text-pink-600 font-bold py-3 px-6 rounded-full shadow-lg hover:bg-green-600 hover:text-white transition duration-300 transform hover:scale-105"
          >
            📝 Register IP
          </button>
          <button
      ...
      {/* Featured IP Assets */}
      <section className="w-full max-w-6xl px-4 py-10 bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl mt-6 animate-fade-in-slow">
